...
// Kept in sync with the builder engine (NewPricingWidget.tsx). Config lives in
// doc.tieredConfig. The CTA emits data-* attributes read by the embed's click
// delegation (Widget.tsx) to start the correct plan's payment/backend flow.
// ---------------------------------------------------------------------------
