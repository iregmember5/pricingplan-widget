  ...
  if (type === "row") {
    ...
    const shouldStack = stackEnabled && (
      hasExplicitHeight
        ...
        : (isMobile || containerWidth < tabletStackBreakpoint || (children.length < 4 && estimatedChildWidth < minChildWidth))
    );
    ...
    const responsiveGap = shouldStack
      ...
      : shouldWrap
        ...
        : baseGap;
    const resolvedGap = responsiveGap;
    ...
    const resolvedMinHeight = shouldStack || shouldAutoHeight
      ...
      : px(node.minHeight);
    const adjustedResolvedHeight = shouldStack || shouldAutoHeight
      ? undefined
